...
public class IbDataBaseUtil {
    ...
    public static void insert(Context context, IceBox ib) {
        ...
        String sql = "insert into ib(r3code, icname, deth, with, height, cmd,location) values(" +
                " ?, ?, ?, ?, ?, ?,?)";
    ...
    public static void delete(Context context, IceBox ib) {
        ...
        SQLiteDatabase database = getIbDatabase(context);
        String sql = "delete from ib where r3code = ?";
    ...
    public static void update(Context context, IceBox ib) {
        SQLiteDatabase database = getIbDatabase(context);
        //更新SQL
        String sql = "update ib set r3code='" + ib.getR3code() + "',icname='" + ib.getIceBoxName() + "',deth='" + ib.getDeth() + "'," +
    ...
    public static IceBox queryItem(String s, Context context) {
        ...
        String sql = "select r3code, icname, deth, with, height,cmd,location from ib where r3code=?";
        SQLiteDatabase database = getIbDatabase(context);
    ...
    public static ArrayList<IceBox> queryAll(Context context) {
        ...
        IceBox ib;
        String sql = "select r3code, icname, deth, with, height, cmd,location from ib";
        SQLiteDatabase database = getIbDatabase(context);
